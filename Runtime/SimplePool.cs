...
public static class SimplePool
{
	...
	const int DEFAULT_POOL_SIZE = 1500;

	public static GameObject TilePrefab = Resources.Load<GameObject>("Prefabs/Iso_Tile");
	public static GameObject IsoObject = Resources.Load<GameObject>("Prefabs/Iso_Object");
	...
	/// call that function.
	/// </summary>
	static public GameObject Spawn(GameObject prefab, Vector3 pos = new Vector3(), Quaternion rot = new Quaternion())
	{
		Init(prefab);
